...
$temperatureFile = file_get_contents('electra.log');
$temperatureFile = file_get_contents('gas.log');
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#" >RaspberryPiWinkel.nl Verbuik</a>
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="#">CPU Temperature</a></li>
              <li class="active"><a href="#">Stroom verbruik</a></li>
							<li class="active"><a href="#">Gas verbruik</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
